...
function PortalHero(){return <header className="portal-hero" id="top">
  ...
  <nav className="portal-grid" aria-label="Explore Joel's work">
    ...
    <a className="portal-card portal-github" href="https://github.com/Welddevelopment" target="_blank" rel="noreferrer"><span>Code</span><strong>GitHub</strong><b>↗</b></a>
