...
function PortalHero(){return <header className="portal-hero" id="top">
  <div className="portal-identity">
    ...
    <div className="portal-direct"><a href="mailto:joeljeon7@gmail.com">joeljeon7@gmail.com</a><a href="https://github.com/Welddevelopment" target="_blank" rel="me noreferrer">GitHub ↗</a></div>
  </div>
...
export function DesignLab({direction,labMode=true}){
  ...
  return <main className={`lab lab-${direction}`} ref={root}>
    ...
    <section className="lab-proof" id="proof"><div className="lab-proof-lead"><span>THE EVIDENCE</span><strong>Built, then<br/>verified.</strong></div><a href="/dynamic-agent-specialisation"><span>CURRENT</span><strong>Dynamic Agent Specialisation</strong><small>Private local prototype</small></a><a href="/dynamic-agent-specialisation"><span>TESTED</span><strong>Three fictional roles</strong><small>Separate outcome verification</small></a><a href="/dynamic-agent-specialisation"><span>DISCIPLINE</span><strong>250+ local checks</strong><small>No unproved upgrades</small></a></section>
    <section className="lab-now lab-das" id="now"><div><span>CURRENT WORK</span><h2>Dynamic Agent<br/>Specialisation.</h2></div><p>DAS takes a bounded business role, builds several complete specialist-agent configurations, tests them against independently checked outcomes, and recommends the strongest safe option only when the evidence justifies switching.</p><div className="lab-now-detail"><p>The private local prototype has been exercised across procurement, SaaS support, and CRM/revenue operations, with more than 250 automated checks. No real customer system has been activated. I also work on Growth/GTM and growth-engineering experiments at Tsenta (YC S26).</p><a className="lab-now-link" href="/dynamic-agent-specialisation">Read the technical note ↗</a></div></section>
    <section className="lab-audit" id="system"><div className="lab-audit-mark">6</div><div className="lab-reveal"><span>CAPABILITY FACTORY / SIX DAYS</span><h2>A missing ability should not end the goal.</h2><p>Capability Factory lets an agent diagnose a missing ability, acquire or reuse the smallest permissioned capability, independently verify the result, and resume its goal. It is a working local pilot MVP for constrained HTTP APIs, tested only with fictional data.</p><div className="lab-audit-actions"><a className="lab-audit-link" href="/capability-factory">Read the technical note ↗</a><a className="lab-audit-link" href="https://capability-factory-website.vercel.app" target="_blank" rel="me noreferrer">Visit Capability Factory ↗</a></div></div></section>
    ...
    <footer className="lab-footer" id="contact"><span>CONTACT ME</span><h2>Say hi.</h2><button onClick={copy}>{copied?'COPIED':'joeljeon7@gmail.com'}<LabArrow/></button><div className="lab-footer-base"><div><a href="https://capability-factory-website.vercel.app" target="_blank" rel="me noreferrer">Capability Factory ↗</a><a href="https://github.com/Welddevelopment/Weld" target="_blank" rel="me noreferrer">weld. GitHub ↗</a><a href="https://x.com/JoelJeonDev" target="_blank" rel="me noreferrer">X ↗</a><span className="lab-linkedin"><del>LinkedIn</del> / BANNED FOR BEING UNDERAGE</span></div><p>I hit 1k followers in under a month, connected with YC founders and Forbes 30-under-30s, and then got banned. Fastest growth curve I’ve ever killed without meaning to.</p></div></footer>
  </main>
}
