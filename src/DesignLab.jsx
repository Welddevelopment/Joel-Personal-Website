...
const projects=[
  ...
  {n:'03',title:'GTM Hack',art:'/work-gtm-hack.png',meta:'Lightfern track / ~150 people / second place',copy:'Built the Voiceprint Funnel with my friend Jawad. We were the only two people in the room who were not university students.'},
  {n:'04',title:'LicenseTrace',art:'/work-license-trace.png',meta:'Solo / two sponsor categories / second place',copy:'An agent that traces hidden open-source license contamination through a dependency tree and proves the exact path. £300 cash and £15k in ontology-AI credits.'}
];
