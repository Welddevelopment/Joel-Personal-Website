...
const projects=[
  {n:'01',title:'weld.',meta:'First product / Roblox talent marketplace',copy:'A marketplace for Roblox developers and studios. I taught myself to code to build it, shipped the landing page on day one, then killed it when the business model did not hold.'},
  {n:'02',title:'Pop the Bubble',meta:'36 hours / 12% acceptance / £10k top prize',copy:'A few weeks into coding, I built Synapse, an AI growth-analytics tool, for the largest hackathon prize in London. Youngest person there. I barely made it through, but I finished.'},
  {n:'03',title:'GTM Hack',meta:'Lightfern track / ~150 people / second place',copy:'Built the Voiceprint Funnel with my friend Jawad. We were the only two people in the room who were not university students.'},
  {n:'04',title:'LicenseTrace',meta:'Solo / two sponsor categories / second place',copy:'An agent that traces hidden open-source license contamination through a dependency tree and proves the exact path. £300 cash and £15k in ontology-AI credits.'}
];
...
function PortalHero(){return <header className="portal-hero" id="top">
  <div className="portal-identity">
    ...
    <p>I spot opportunities, learn what is required, and turn ideas into proof.</p>
  ...
  <nav className="portal-grid" aria-label="Explore Joel's work">
    ...
    <a className="portal-card portal-current" href="#now"><span>Current work</span><strong>Tsenta</strong><small>Leading GTM at a YC S26 company.</small><b>↘</b></a>
    ...
    <a className="portal-card portal-contact" href="mailto:joeljeon7@gmail.com"><span>Contact</span><strong>Email me</strong><small>Usually the fastest route.</small><b>↗</b></a>
  </nav>
</header>}
