...
function App(){
  ...
  return <main ref={root}>
    ...
    <nav className="nav"><a className="monogram" href="#top">JJ<span>®</span></a><div className="nav-center"><a href="#story">Story</a><a href="#work">Work</a><a href="#contact">Contact</a></div><a className="available" href="mailto:joeljeon7@gmail.com"><i/>Open to conversations</a></nav>
